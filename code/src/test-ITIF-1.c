 ...
 * Author: norberto
 *
 *  Test to verify correct initialization of AuK
 * 
 */
...
int main(void) 
{
    ...
    //x = init_AuK(7.3728E+6, 0.005);
    //x = init_AuK(7.3728E+6, 0.01);
    //x = init_AuK(59.904E+6, 0.1);
    
    // Value to fail.
    // x = init_AuK(59.904E+6, 1.0);
    
    // Limit values in boolean expressions
    //x = init_AuK(655340.0, 0.1);
    //x = init_AuK(655350.0, 0.1);
    //x = init_AuK(5242720.0, 0.1);
    //x = init_AuK(5242800.0, 0.1);
    //x = init_AuK(41941760.0, 0.1);
    //x = init_AuK(41942400.0, 0.1);
    //x = init_AuK(167767040.0, 0.1);
    x = init_AuK(167769600.0, 0.1);
