...
#include "xc.h"
#include "AuK_glass_clear_v1_1_8.h"
#include <libpic30.h>
#include <stdio.h>
...
void test_task()
{
    ...
    while(1)
    {
        do
        {                       
            TSlock((unsigned int)&lock, (unsigned int)&answer);
        }
        while(answer == 1);
        ...
        switch(own_id)
        {
            ...
            case 1: PORTBbits.RB1 = 1;
                    break;
            case 2: PORTAbits.RA1 = 1;
                    break;
            case 3: PORTBbits.RB13 = 1;
                    break;
            case 4: PORTBbits.RB12 = 1;
                    break;
            case 5: PORTBbits.RB11 = 1;
                    break;
            case 6: PORTBbits.RB10 = 1;
                    break;
            case 7: PORTCbits.RC9 = 1;
                    break;
            case 8: PORTCbits.RC8 = 1;
                    break;
            case 9: PORTCbits.RC7 = 1;
                    break;
            default: break;
        }
        ...
        switch(own_id)
        {
            ...
            case 2: PORTAbits.RA1 = 0;
                    break;
            case 3: PORTBbits.RB13 = 0;
                    break;
            case 4: PORTBbits.RB12 = 0;
                    break;
            case 5: PORTBbits.RB11 = 0;
                    break;
            case 6: PORTBbits.RB10 = 0;
                    break;
            case 7: PORTCbits.RC9 = 0;
                    break;
            case 8: PORTCbits.RC8 = 0;
                    break;
            case 9: PORTCbits.RC7 = 0;
                    break;
            default: break;
        }    
       
        TSunlock((unsigned int)&lock);   
