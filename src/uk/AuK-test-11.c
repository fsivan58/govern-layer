 ...
 * 
 * Verification of the correct handling of processes with code beyond 64K.
 * It is necessary to change the code generation model to "large"
 * (Production-> Set project configuration -> XC16 -> Code model -> Large).
 */
...
void __attribute__ ((address(0x20000))) test_task()
{
    int id;
    int period = 10;
    int counter = 0;
        ...
        while(1)
        {
            ...
            switch(id)
            {
                case 1: PORTBbits.RB1 = 1;
                        ...
                        PORTBbits.RB1 = 0;
                        break;
                case 2: PORTBbits.RB2 = 1;
                        __delay32(5);
                        PORTBbits.RB2 = 0;
                        break;
                case 3: PORTBbits.RB3 = 1;
                        __delay32(5);
                        PORTBbits.RB3 = 0;
                        break;
                case 4: PORTBbits.RB4 = 1;
                        __delay32(5);
                        PORTBbits.RB4 = 0;
                        break;
                case 5: PORTBbits.RB5 = 1;
                        ...
                        PORTBbits.RB5 = 0;
                        break;
                case 6: PORTBbits.RB6 = 1;
                        __delay32(5);
                        PORTBbits.RB6 = 0;
                        break;
                case 7: PORTBbits.RB7 = 1;
                        __delay32(5);
                        PORTBbits.RB7 = 0;
                        break;
                case 8: PORTBbits.RB8 = 1;
                        __delay32(5);
                        PORTBbits.RB8 = 0;
                        break;
                case 9: PORTBbits.RB9 = 1;
                        __delay32(5);
                        PORTBbits.RB9 = 0;
                        break;
                default: break;                        
...
int main(void) 
{
    ...
    x = init_tmr1_int_frequency(59.904E+6, 0.01);
    
    init_task_manager();
    
    mutex_init(&M_print, 2);
         
    for(x = 0; x < 10; x++)
        t_id = create_task(__builtin_tblpage(test_task),
                           __builtin_tbloffset(test_task), 200, x +1);
